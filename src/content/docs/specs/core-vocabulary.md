...
- JSON-LD 1.1 Contexts: [https://www.w3.org/TR/json-ld11/#the-context](https://www.w3.org/TR/json-ld11/#the-context)
- Friends General Conference (FGC): [https://www.fgcquaker.org](https://www.fgcquaker.org)
- Friends United Meeting (FUM): [https://www.fum.org](https://www.fum.org)
- Evangelical Friends International (EFI): [https://www.evangelicalfriends.org](https://www.evangelicalfriends.org)
- Britain Yearly Meeting: [https://www.quaker.org.uk](https://www.quaker.org.uk)
- Quaker Cloud project: [https://quaker.cloud](https://quaker.cloud)
- Quaker Cloud namespace: [https://quaker.cloud/spec/ns/](https://quaker.cloud/spec/ns/)
